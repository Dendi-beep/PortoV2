...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "dedeny1321@gmai.com" },
    { icon: Phone, label: "Phone", value: "+62 853 7951 5740" },
    { icon: MapPin, label: "Location", value: "Lampung, Indonesia" },
  ];

  return (
    <section
      ref={sectionRef}
      className="py-20 bg-gradient-to-br from-orange-400 via-red-400 to-pink-400"
    >
            ...
            <div>
              ...
              >
                ...
                <p className="text-white text-opacity-90 leading-relaxed">
                  Siap memulai proyek Anda berikutnya? Mari kita ciptakan
                  sesuatu yang luar biasa bersama. Saya selalu bersemangat untuk
                  mengerjakan tantangan baru dan mewujudkan ide-ide inovatif.
                </p>
              </div>
            </div>
